...
export default {
	...
	'moment-timezone-with-data-2012-2022.min': require('../highcharts-files/moment-timezone-with-data-2012-2022.min.hcscript'),
	'moment.min': require('../highcharts-files/moment.min.hcscript'),
	modules: {
		annotations: require('../highcharts-files/modules/annotations.hcscript'),
